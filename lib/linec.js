...
program.version('0.1.0').option('-i, --ignore [path]', 'ignore path | <example> linec -i \'./dist\'').option('-p, --path [path]', 'linec path | <example> linec -p \'./dist\'').option('-o, --output', 'ouput html | <example> linec -o').parse(process.argv);
